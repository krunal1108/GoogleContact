        ...
        <Container fluid>
            ...
            <thead>
                    <tr>
                        ...
                        <th className='border border-dark text-center font'>Avatar</th>
                        <th className='border border-dark text-center font'>Name</th>
                        <th className='border border-dark text-center w-25 font'>Email</th>
                        <th className='border border-dark text-center font'>Phone number</th>    
                        <th className='border border-dark text-center w-25 font'>Notes</th>
                        <th className='border border-dark text-center font'>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    {
